...
public class App extends Application {
    ...
    private void createScene1(){
        ...
        VBox vBox1 = new VBox(10,hbox1, hBox4, hBox2, hBox3);
        vBox1.setAlignment(Pos.CENTER);
        vBox1.setStyle("-fx-background-color:#F8F6F4;");
        
        Scene scene1 = new Scene(vBox1,620,620);
    ...
    private void createSceneBerhasil() {
        Text text = new Text("Anda telah berhasil Sign Up, silahkan kembali ke halaman utama");
        ...
        VBox vBox = new VBox(15, text, hBox);
